...
# Lords of Diskonia is a ten-level turn-based strategy campaign (o33_Game, story mode,
# `lvl` 1..10). Nothing from this game enters the multiworld pool -- its only item is
