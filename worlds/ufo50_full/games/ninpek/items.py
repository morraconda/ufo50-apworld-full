...
# Ninpek is an endless arcade run-and-gun (o34_Mas). Nothing from this game enters the
# multiworld pool -- its only item is the Encouragement filler (a nothing item, hence a
# "bad filler" game). The framework pads every location with filler from the other games.
