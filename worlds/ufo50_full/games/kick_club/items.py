...
REAL_SECOND = "+1 Real Second"
EXTRA_LIFE = "Extra Life"

# id offset layout inside Kick Club's 1000-id block:
#   1  +1 Real Second  (progression -- each adds 1 real second to every level's timer,
...
def create_items(world: "UFO50World") -> list[Item]:
    # 40x +1 Real Second + 10x Extra Life; the framework pads the rest with filler,
    # which is also "+1 Real Second".
